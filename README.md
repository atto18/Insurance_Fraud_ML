...
scale_pos_weight (≈ 6715 for XGBoost)
---
Method 2 — Iterative Training (Balanced Sampling)
Models: LightGBM, XGBoost
Each iteration:
All 187 fraud cases
200 randomly sampled non-fraud
100 iterations
Final prediction = average of all iterations
Training settings:
n_iterations = 100
n_negatives_per_iter = 200
test_size = 0.2
random_state = 42
Optuna tuning with 25 trials per model
---
Results
Method 1 — Standard Training (Full Dataset)
Model	AUROC	AUPRC
...
---
Output
`data/final/scored_providers.csv`
Contains fraud risk scores for all providers.
---
Limitations
...
---
Conclusion
This project shows that machine learning can successfully rank high-risk providers even in highly imbalanced data.
By focusing on the top-ranked providers, the system reduces the investigation space while capturing a large portion of fraud cases.
